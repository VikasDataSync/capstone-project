...
MLFLOW_TRACKING_URI = "https://dagshub.com/VikasDataSync/capstone-project.mlflow"
...
def preprocess_text(text):
    ...
    try:
        text = " ".join([lemmatizer.lemmatize(word) for word in filtered_words])  # Lemmatization & stopwords removal
    except LookupError:
        ensure_nltk_resources()
        try:
            text = " ".join([lemmatizer.lemmatize(word) for word in filtered_words])
        except LookupError:
